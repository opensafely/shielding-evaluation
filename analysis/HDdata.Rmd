...
dat  <- dat %>% mutate(freqH = ifelse(freqH<8,NA,freqH)) %>%
                write.csv(file=paste0(filepart,"_all.csv"))   #NEED?      #show data
#by_age
...
#...very long
#...run this
#...if works, do Figs 2-4
#...see if function possible
...
DateLim_H1  = range(datH$DatesH[which(datH$ageg==1)])
DateLim_H2  = range(datH$DatesH[which(datH$ageg==2)],na.rm=T)
DateLim_H3  = range(datH$DatesH[which(datH$ageg==3)],na.rm=T)
DateLim_H4  = range(datH$DatesH[which(datH$ageg==4)],na.rm=T)
DateLim_H5  = range(datH$DatesH[which(datH$ageg==5)],na.rm=T)
DateLim_H6  = range(datH$DatesH[which(datH$ageg==6)])
DateLim_H7  = range(datH$DatesH[which(datH$ageg==7)])
DateLim_H8  = range(datH$DatesH[which(datH$ageg==8)])
DateLim_H9  = range(datH$DatesH[which(datH$ageg==9)])
DateLim_H10 = range(datH$DatesH[which(datH$ageg==1 & datH$shield=="0")])
DateLim_H20 = range(datH$DatesH[which(datH$ageg==2 & datH$shield=="0")])
DateLim_H30 = range(datH$DatesH[which(datH$ageg==3 & datH$shield=="0")])
DateLim_H40 = range(datH$DatesH[which(datH$ageg==4 & datH$shield=="0")])
DateLim_H50 = range(datH$DatesH[which(datH$ageg==5 & datH$shield=="0")])
DateLim_H60 = range(datH$DatesH[which(datH$ageg==6 & datH$shield=="0")])
DateLim_H70 = range(datH$DatesH[which(datH$ageg==7 & datH$shield=="0")])
DateLim_H80 = range(datH$DatesH[which(datH$ageg==8 & datH$shield=="0")])
DateLim_H90 = range(datH$DatesH[which(datH$ageg==9 & datH$shield=="0")])
DateLim_H11 = range(datH$DatesH[which(datH$ageg==1 & datH$shield=="1")])
DateLim_H21 = range(datH$DatesH[which(datH$ageg==2 & datH$shield=="1")])
DateLim_H31 = range(datH$DatesH[which(datH$ageg==3 & datH$shield=="1")])
DateLim_H41 = range(datH$DatesH[which(datH$ageg==4 & datH$shield=="1")])
DateLim_H51 = range(datH$DatesH[which(datH$ageg==5 & datH$shield=="1")])
DateLim_H61 = range(datH$DatesH[which(datH$ageg==6 & datH$shield=="1")])
DateLim_H71 = range(datH$DatesH[which(datH$ageg==7 & datH$shield=="1")])
DateLim_H81 = range(datH$DatesH[which(datH$ageg==8 & datH$shield=="1")])
DateLim_H91 = range(datH$DatesH[which(datH$ageg==9 & datH$shield=="1")])
#
WeekLim_H   = range(datH$WeeksH)
WeekLim_H1  = range(datH$WeeksH[which(datH$ageg==1)])
WeekLim_H2  = range(datH$WeeksH[which(datH$ageg==2)],na.rm=T)
WeekLim_H3  = range(datH$WeeksH[which(datH$ageg==3)],na.rm=T)
WeekLim_H4  = range(datH$WeeksH[which(datH$ageg==4)],na.rm=T)
WeekLim_H5  = range(datH$WeeksH[which(datH$ageg==5)],na.rm=T)
WeekLim_H6  = range(datH$WeeksH[which(datH$ageg==6)])
WeekLim_H7  = range(datH$WeeksH[which(datH$ageg==7)])
WeekLim_H8  = range(datH$WeeksH[which(datH$ageg==8)])
WeekLim_H9  = range(datH$WeeksH[which(datH$ageg==9)])
WeekLim_H10 = range(datH$WeeksH[which(datH$ageg==1 & datH$shield=="0")])
WeekLim_H20 = range(datH$WeeksH[which(datH$ageg==2 & datH$shield=="0")])
WeekLim_H30 = range(datH$WeeksH[which(datH$ageg==3 & datH$shield=="0")])
WeekLim_H40 = range(datH$WeeksH[which(datH$ageg==4 & datH$shield=="0")])
WeekLim_H50 = range(datH$WeeksH[which(datH$ageg==5 & datH$shield=="0")])
WeekLim_H60 = range(datH$WeeksH[which(datH$ageg==6 & datH$shield=="0")])
WeekLim_H70 = range(datH$WeeksH[which(datH$ageg==7 & datH$shield=="0")])
WeekLim_H80 = range(datH$WeeksH[which(datH$ageg==8 & datH$shield=="0")])
WeekLim_H90 = range(datH$WeeksH[which(datH$ageg==9 & datH$shield=="0")])
WeekLim_H11 = range(datH$WeeksH[which(datH$ageg==1 & datH$shield=="1")])
WeekLim_H21 = range(datH$WeeksH[which(datH$ageg==2 & datH$shield=="1")])
WeekLim_H31 = range(datH$WeeksH[which(datH$ageg==3 & datH$shield=="1")])
WeekLim_H41 = range(datH$WeeksH[which(datH$ageg==4 & datH$shield=="1")])
WeekLim_H51 = range(datH$WeeksH[which(datH$ageg==5 & datH$shield=="1")])
WeekLim_H61 = range(datH$WeeksH[which(datH$ageg==6 & datH$shield=="1")])
WeekLim_H71 = range(datH$WeeksH[which(datH$ageg==7 & datH$shield=="1")])
WeekLim_H81 = range(datH$WeeksH[which(datH$ageg==8 & datH$shield=="1")])
WeekLim_H91 = range(datH$WeeksH[which(datH$ageg==9 & datH$shield=="1")])

##DH
DateLim_DH   = range(datDH$DatesD)
DateLim_DH1  = range(datDH$DatesD[which(datDH$ageg==1)],na.rm=T)
DateLim_DH2  = range(datDH$DatesD[which(datDH$ageg==2)],na.rm=T)
DateLim_DH3  = range(datDH$DatesD[which(datDH$ageg==3)],na.rm=T)
DateLim_DH4  = range(datDH$DatesD[which(datDH$ageg==4)],na.rm=T)
DateLim_DH5  = range(datDH$DatesD[which(datDH$ageg==5)],na.rm=T)
DateLim_DH6  = range(datDH$DatesD[which(datDH$ageg==6)])
DateLim_DH7  = range(datDH$DatesD[which(datDH$ageg==7)])
DateLim_DH8  = range(datDH$DatesD[which(datDH$ageg==8)])
DateLim_DH9  = range(datDH$DatesD[which(datDH$ageg==9)])
DateLim_DH10 = range(datDH$DatesD[which(datDH$ageg==1 & datDH$shield=="0")],na.rm=T)
DateLim_DH20 = range(datDH$DatesD[which(datDH$ageg==2 & datDH$shield=="0")],na.rm=T)
DateLim_DH30 = range(datDH$DatesD[which(datDH$ageg==3 & datDH$shield=="0")],na.rm=T)
DateLim_DH40 = range(datDH$DatesD[which(datDH$ageg==4 & datDH$shield=="0")],na.rm=T)
DateLim_DH50 = range(datDH$DatesD[which(datDH$ageg==5 & datDH$shield=="0")],na.rm=T)
DateLim_DH60 = range(datDH$DatesD[which(datDH$ageg==6 & datDH$shield=="0")])
DateLim_DH70 = range(datDH$DatesD[which(datDH$ageg==7 & datDH$shield=="0")])
DateLim_DH80 = range(datDH$DatesD[which(datDH$ageg==8 & datDH$shield=="0")])
DateLim_DH90 = range(datDH$DatesD[which(datDH$ageg==9 & datDH$shield=="0")])
DateLim_DH11 = range(datDH$DatesD[which(datDH$ageg==1 & datDH$shield=="1")],na.rm=T)
DateLim_DH21 = range(datDH$DatesD[which(datDH$ageg==2 & datDH$shield=="1")],na.rm=T)
DateLim_DH31 = range(datDH$DatesD[which(datDH$ageg==3 & datDH$shield=="1")],na.rm=T)
DateLim_DH41 = range(datDH$DatesD[which(datDH$ageg==4 & datDH$shield=="1")],na.rm=T)
DateLim_DH51 = range(datDH$DatesD[which(datDH$ageg==5 & datDH$shield=="1")],na.rm=T)
DateLim_DH61 = range(datDH$DatesD[which(datDH$ageg==6 & datDH$shield=="1")])
DateLim_DH71 = range(datDH$DatesD[which(datDH$ageg==7 & datDH$shield=="1")])
DateLim_DH81 = range(datDH$DatesD[which(datDH$ageg==8 & datDH$shield=="1")])
DateLim_DH91 = range(datDH$DatesD[which(datDH$ageg==9 & datDH$shield=="1")])
#
WeekLim_DH   = range(datDH$WeeksD)
WeekLim_DH1  = range(datDH$WeeksD[which(datDH$ageg==1)],na.rm=T)
WeekLim_DH2  = range(datDH$WeeksD[which(datDH$ageg==2)],na.rm=T)
WeekLim_DH3  = range(datDH$WeeksD[which(datDH$ageg==3)],na.rm=T)
WeekLim_DH4  = range(datDH$WeeksD[which(datDH$ageg==4)],na.rm=T)
WeekLim_DH5  = range(datDH$WeeksD[which(datDH$ageg==5)],na.rm=T)
WeekLim_DH6  = range(datDH$WeeksD[which(datDH$ageg==6)])
WeekLim_DH7  = range(datDH$WeeksD[which(datDH$ageg==7)])
WeekLim_DH8  = range(datDH$WeeksD[which(datDH$ageg==8)])
WeekLim_DH9  = range(datDH$WeeksD[which(datDH$ageg==9)])
WeekLim_DH10 = range(datDH$WeeksD[which(datDH$ageg==1 & datDH$shield=="0")],na.rm=T)
WeekLim_DH20 = range(datDH$WeeksD[which(datDH$ageg==2 & datDH$shield=="0")],na.rm=T)
WeekLim_DH30 = range(datDH$WeeksD[which(datDH$ageg==3 & datDH$shield=="0")],na.rm=T)
WeekLim_DH40 = range(datDH$WeeksD[which(datDH$ageg==4 & datDH$shield=="0")],na.rm=T)
WeekLim_DH50 = range(datDH$WeeksD[which(datDH$ageg==5 & datDH$shield=="0")],na.rm=T)
WeekLim_DH60 = range(datDH$WeeksD[which(datDH$ageg==6 & datDH$shield=="0")])
WeekLim_DH70 = range(datDH$WeeksD[which(datDH$ageg==7 & datDH$shield=="0")])
WeekLim_DH80 = range(datDH$WeeksD[which(datDH$ageg==8 & datDH$shield=="0")])
WeekLim_DH90 = range(datDH$WeeksD[which(datDH$ageg==9 & datDH$shield=="0")])
WeekLim_DH11 = range(datDH$WeeksD[which(datDH$ageg==1 & datDH$shield=="1")],na.rm=T)
WeekLim_DH21 = range(datDH$WeeksD[which(datDH$ageg==2 & datDH$shield=="1")],na.rm=T)
WeekLim_DH31 = range(datDH$WeeksD[which(datDH$ageg==3 & datDH$shield=="1")],na.rm=T)
WeekLim_DH41 = range(datDH$WeeksD[which(datDH$ageg==4 & datDH$shield=="1")],na.rm=T)
WeekLim_DH51 = range(datDH$WeeksD[which(datDH$ageg==5 & datDH$shield=="1")],na.rm=T)
WeekLim_DH61 = range(datDH$WeeksD[which(datDH$ageg==6 & datDH$shield=="1")])
WeekLim_DH71 = range(datDH$WeeksD[which(datDH$ageg==7 & datDH$shield=="1")])
WeekLim_DH81 = range(datDH$WeeksD[which(datDH$ageg==8 & datDH$shield=="1")])
WeekLim_DH91 = range(datDH$WeeksD[which(datDH$ageg==9 & datDH$shield=="1")])

##DO
DateLim_DO   = range(datDO$DatesD)
DateLim_DO1  = range(datDO$DatesD[which(datDO$ageg==1)],na.rm=T)
DateLim_DO2  = range(datDO$DatesD[which(datDO$ageg==2)],na.rm=T)
DateLim_DO3  = range(datDO$DatesD[which(datDO$ageg==3)],na.rm=T)
DateLim_DO4  = range(datDO$DatesD[which(datDO$ageg==4)],na.rm=T)
DateLim_DO5  = range(datDO$DatesD[which(datDO$ageg==5)],na.rm=T)
DateLim_DO6  = range(datDO$DatesD[which(datDO$ageg==6)])
DateLim_DO7  = range(datDO$DatesD[which(datDO$ageg==7)])
DateLim_DO8  = range(datDO$DatesD[which(datDO$ageg==8)])
DateLim_DO9  = range(datDO$DatesD[which(datDO$ageg==9)])
DateLim_DO10 = range(datDO$DatesD[which(datDO$ageg==1 & datDO$shield=="0")],na.rm=T)
DateLim_DO20 = range(datDO$DatesD[which(datDO$ageg==2 & datDO$shield=="0")],na.rm=T)
DateLim_DO30 = range(datDO$DatesD[which(datDO$ageg==3 & datDO$shield=="0")],na.rm=T)
DateLim_DO40 = range(datDO$DatesD[which(datDO$ageg==4 & datDO$shield=="0")],na.rm=T)
DateLim_DO50 = range(datDO$DatesD[which(datDO$ageg==5 & datDO$shield=="0")],na.rm=T)
DateLim_DO60 = range(datDO$DatesD[which(datDO$ageg==6 & datDO$shield=="0")])
DateLim_DO70 = range(datDO$DatesD[which(datDO$ageg==7 & datDO$shield=="0")])
DateLim_DO80 = range(datDO$DatesD[which(datDO$ageg==8 & datDO$shield=="0")])
DateLim_DO90 = range(datDO$DatesD[which(datDO$ageg==9 & datDO$shield=="0")])
DateLim_DO11 = range(datDO$DatesD[which(datDO$ageg==1 & datDO$shield=="1")],na.rm=T)
DateLim_DO21 = range(datDO$DatesD[which(datDO$ageg==2 & datDO$shield=="1")],na.rm=T)
DateLim_DO31 = range(datDO$DatesD[which(datDO$ageg==3 & datDO$shield=="1")],na.rm=T)
DateLim_DO41 = range(datDO$DatesD[which(datDO$ageg==4 & datDO$shield=="1")],na.rm=T)
DateLim_DO51 = range(datDO$DatesD[which(datDO$ageg==5 & datDO$shield=="1")],na.rm=T)
DateLim_DO61 = range(datDO$DatesD[which(datDO$ageg==6 & datDO$shield=="1")])
DateLim_DO71 = range(datDO$DatesD[which(datDO$ageg==7 & datDO$shield=="1")])
DateLim_DO81 = range(datDO$DatesD[which(datDO$ageg==8 & datDO$shield=="1")])
DateLim_DO91 = range(datDO$DatesD[which(datDO$ageg==9 & datDO$shield=="1")])
#
WeekLim_DO   = range(datDO$WeeksD)
WeekLim_DO1  = range(datDO$WeeksD[which(datDO$ageg==1)],na.rm=T)
WeekLim_DO2  = range(datDO$WeeksD[which(datDO$ageg==2)],na.rm=T)
WeekLim_DO3  = range(datDO$WeeksD[which(datDO$ageg==3)],na.rm=T)
WeekLim_DO4  = range(datDO$WeeksD[which(datDO$ageg==4)],na.rm=T)
WeekLim_DO5  = range(datDO$WeeksD[which(datDO$ageg==5)],na.rm=T)
WeekLim_DO6  = range(datDO$WeeksD[which(datDO$ageg==6)])
WeekLim_DO7  = range(datDO$WeeksD[which(datDO$ageg==7)])
WeekLim_DO8  = range(datDO$WeeksD[which(datDO$ageg==8)])
WeekLim_DO9  = range(datDO$WeeksD[which(datDO$ageg==9)])
WeekLim_DO10 = range(datDO$WeeksD[which(datDO$ageg==1 & datDO$shield=="0")],na.rm=T)
WeekLim_DO20 = range(datDO$WeeksD[which(datDO$ageg==2 & datDO$shield=="0")],na.rm=T)
WeekLim_DO30 = range(datDO$WeeksD[which(datDO$ageg==3 & datDO$shield=="0")],na.rm=T)
WeekLim_DO40 = range(datDO$WeeksD[which(datDO$ageg==4 & datDO$shield=="0")],na.rm=T)
WeekLim_DO50 = range(datDO$WeeksD[which(datDO$ageg==5 & datDO$shield=="0")],na.rm=T)
WeekLim_DO60 = range(datDO$WeeksD[which(datDO$ageg==6 & datDO$shield=="0")])
WeekLim_DO70 = range(datDO$WeeksD[which(datDO$ageg==7 & datDO$shield=="0")])
WeekLim_DO80 = range(datDO$WeeksD[which(datDO$ageg==8 & datDO$shield=="0")])
WeekLim_DO90 = range(datDO$WeeksD[which(datDO$ageg==9 & datDO$shield=="0")])
WeekLim_DO11 = range(datDO$WeeksD[which(datDO$ageg==1 & datDO$shield=="1")],na.rm=T)
WeekLim_DO21 = range(datDO$WeeksD[which(datDO$ageg==2 & datDO$shield=="1")],na.rm=T)
WeekLim_DO31 = range(datDO$WeeksD[which(datDO$ageg==3 & datDO$shield=="1")],na.rm=T)
WeekLim_DO41 = range(datDO$WeeksD[which(datDO$ageg==4 & datDO$shield=="1")],na.rm=T)
WeekLim_DO51 = range(datDO$WeeksD[which(datDO$ageg==5 & datDO$shield=="1")],na.rm=T)
WeekLim_DO61 = range(datDO$WeeksD[which(datDO$ageg==6 & datDO$shield=="1")])
WeekLim_DO71 = range(datDO$WeeksD[which(datDO$ageg==7 & datDO$shield=="1")])
WeekLim_DO81 = range(datDO$WeeksD[which(datDO$ageg==8 & datDO$shield=="1")])
WeekLim_DO91 = range(datDO$WeeksD[which(datDO$ageg==9 & datDO$shield=="1")])
