...
DAT  <- arrow::read_parquet(file = here::here("output/data_edited.gz.parquet"),
        ...
        mutate(shieldA  = replace(shieldB, is.na(shieldB), as.factor(0)))     # TODO:test shield_date< admi_date &death_date
...
cat("\n")
cat("ShieldA deaths in hospital - mortality fraction by age \n")
mfraction_00_sA1 = frt2(nP_DH_00_sA1,nP_Hosp_00_sA1)
mfraction_05_sA1 = frt2(nP_DH_05_sA1,nP_Hosp_05_sA1)
mfraction_12_sA1 = frt2(nP_DH_12_sA1,nP_Hosp_12_sA1)
mfraction_18_sA1 = frt2(nP_DH_18_sA1,nP_Hosp_18_sA1)
mfraction_30_sA1 = frt2(nP_DH_30_sA1,nP_Hosp_30_sA1)
mfraction_40_sA1 = frt2(nP_DH_40_sA1,nP_Hosp_40_sA1)
mfraction_50_sA1 = frt2(nP_DH_50_sA1,nP_Hosp_50_sA1)
mfraction_60_sA1 = frt2(nP_DH_60_sA1,nP_Hosp_60_sA1)
mfraction_70_sA1 = frt2(nP_DH_70_sA1,nP_Hosp_70_sA1)
...
cat("\n")
cat("ShieldA/Not deaths in hospital - mortality fraction by age \n")
##TODO: NOT NEC: men_time_to_death_1, men_time_to_recover_1 - assume shielding independent
mfraction_00_sA1 = frt2(nP_DH_00_sA1,nP_Hosp_00_sA1)
mfraction_05_sA1 = frt2(nP_DH_05_sA1,nP_Hosp_05_sA1)
mfraction_12_sA1 = frt2(nP_DH_12_sA1,nP_Hosp_12_sA1)
...
mfraction_70_sA1 = frt2(nP_DH_70_sA1,nP_Hosp_70_sA1)
#
mfraction_00_sA0 = frt2(nP_DH_00_sA0,nP_Hosp_00_sA0)
mfraction_05_sA0 = frt2(nP_DH_05_sA0,nP_Hosp_05_sA0)
mfraction_12_sA0 = frt2(nP_DH_12_sA0,nP_Hosp_12_sA0)
mfraction_18_sA0 = frt2(nP_DH_18_sA0,nP_Hosp_18_sA0)
mfraction_30_sA0 = frt2(nP_DH_30_sA0,nP_Hosp_30_sA0)
mfraction_40_sA0 = frt2(nP_DH_40_sA0,nP_Hosp_40_sA0)
mfraction_50_sA0 = frt2(nP_DH_50_sA0,nP_Hosp_50_sA0)
mfraction_60_sA0 = frt2(nP_DH_60_sA0,nP_Hosp_60_sA0)
mfraction_70_sA0 = frt2(nP_DH_70_sA0,nP_Hosp_70_sA0)
#
print(paste0("ShieldA hosp mfraction age 0-4:    ", mfraction_00_sA1 ))
print(paste0("ShieldA hosp mfraction age 5-11:   ", mfraction_05_sA1 ))
print(paste0("ShieldA hosp mfraction age 12-17:  ", mfraction_12_sA1 ))
