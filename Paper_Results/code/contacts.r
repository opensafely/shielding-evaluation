...
cat(paste0("... Date range of model run, ", Week1_Model, ", ", Week2_Model), "\n")
...
#### symmeterised, normalised contact vector
  ...
  cat(paste0("... Matrix input: ", filecontacts), "\n")
...
#### output
sink(file = paste0(output_dir,"/",pset$File_contact_summary,"_",TODAY,".txt"), append=FALSE, split=FALSE)
